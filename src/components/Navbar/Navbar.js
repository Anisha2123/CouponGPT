    ...
    <>
      <NavContainer>
        ...
        <MainNav>
          <Logo to="/">
            <motion.img
              src="https://res.cloudinary.com/dqt4zammn/image/upload/v1734766414/wmremove-transformed_1_sx8u6f.jpg"
              alt="CouponnGPT Logo"
          ...
          <RightSection>
            <CountrySelect>
              <img src="/india-flag.png" alt="IN" style={{ width: 20, height: 20 }} />
              IN
            </CountrySelect>
      ...
      <SearchContainer>
        <SearchBar>
          <input type="text" placeholder="Search for brands, categories, or coupons..." />
